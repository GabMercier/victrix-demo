...
sections:
  - _bookshop_name: hero
    ...
    subtitle: >-
      Témoignage, bandeau de logos partenaires, chiffres en preuve sociale et
      vidéo en façade — quatre blocs réutilisables sur toute page composable.
    ctaLabel: Nous joindre
    ctaHref: /fr/contact
  - _bookshop_name: testimonial
    type: testimonial
    quote: >-
      Victrix a transformé notre posture de sécurité en quelques mois — une
      équipe rigoureuse, à l'écoute, qui parle le langage des affaires.
    name: Marie Lavoie
