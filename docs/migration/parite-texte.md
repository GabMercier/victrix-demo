...
Et 77 pages où un titre de la source est absent mais son texte retrouvé (≈ titre
...
|  | `/en/services/cloud-services-provider/` | `/en/expertise/cloud-services-provider/` | 732 | 570 | 0,78 | ≈ « Microsoft Azure Cloud Services » · « Amazon Web Services (AWS) » · « Elements to Analyze » (+3) | `src/content/services/en/services-infonuagiques.json` |
...
|  | `/fr/services/cybersecurite/internet-des-objets-service-iot/` | `/expertise/cybersecurite/internet-des-objets-service-iot/` | 515 | 464 | 0,90 | ≈ « Victrix assure la sécurité des systèmes IoT et OT » · « Expertise sectorielle en OT/IoT et cybersécurité » | `src/content/services/fr/cybersecurite/internet-des-objets-service-iot.json` |
|  | `/en/services/cybersecurity/internet-of-things-iot/` | `/en/expertise/cybersecurity/internet-of-things-iot/` | 453 | 413 | 0,91 |  | `src/content/services/en/cybersecurite/internet-des-objets-service-iot.json` |
...
|  | `/en/services/cloud-services-provider/azure-migration/` | `/en/expertise/cloud-services-provider/azure-migration/` | 797 | 746 | 0,94 | ≈ « Learn More About Microsoft Azure Cloud Services » · « Our Microsoft Azure Services » · « Microsoft Solution Partner and Azure Managed Services » (+1) | `src/content/services/en/services-infonuagiques/migration-vers-azure.json` |
...
|  | `/en/services/managed-it-services/` | `/en/expertise/managed-it-services/` | 841 | 797 | 0,95 | ≈ « Discover How Our Managed IT Services Empower Your Teams t… » · « Victrix: Solving Your IT Management Challenges » · « Compare Victrix Managed Services vs. In-House IT Management » | `src/content/services/en/services-ti-geres.json` |
|  | `/en/services/cloud-services-provider/aws-services/` | `/en/expertise/cloud-services-provider/aws-services/` | 585 | 556 | 0,95 | ≈ « Learn More About the AWS Cloud Solution » · « Ensure Smooth, Secure and Efficient Migration with Victri… » · « Victrix, Your Trusted AWS Service Provider » | `src/content/services/en/services-infonuagiques/services-aws.json` |
...
|  | `/fr/services/cybersecurite/centre-operationnel-de-securite-evolutif/` | `/expertise/cybersecurite/centre-operationnel-de-securite-evolutif/` (+1) | 637 | 610 | 0,96 | ≈ « Intéressés ? Des questions ? » · « Une offre adaptative » · « Bénéficiez de notre centre opérationnel de sécurité évolu… » | `src/content/services/fr/cybersecurite/centre-operationnel-de-securite-evolutif.json` |
| ☑ assumée — Abandon VOLONTAIRE (lot L-restaure, 2026-09-23). L'ancienne page finissait par deux blocs que la refonte ne reprend pas : « Vie chez Victrix » (18 mots, teaser vers Carrières — la page Carrières porte maintenant ce contenu) et « Ils nous font confiance » (bandeau de logos sans texte, rattaché à la décision D4 sur les logos). La page EN équivalente n'est pas signalée. | `/fr/services/conseil-strategique/` | `/expertise/conseil-strategique/` | 322 | 309 | 0,96 | ✗ « Vie chez Victrix » (30 %)<br>≈ « Rencontrez nos experts » · « Ils nous fontconfiance » · « Assurez le succès de vos projets stratégiques avec Victrix » | `src/content/services/fr/conseil-strategique.json` |
|  | `/en/services/cybersecurity/scalable-security-operations-center/` | `/en/expertise/cybersecurity/scalable-security-operations-center/` | 572 | 552 | 0,97 | ≈ « Interested? Have Any Questions? » · « An Adaptative Cybersecurity Solution » | `src/content/services/en/cybersecurite/centre-operationnel-de-securite-evolutif.json` |
...
|  | `/fr/services/productivite/o-studio/` | `/expertise/productivite/o-studio/` | 694 | 708 | 1,02 | ≈ « FAQ — Développement d’applications Microsoft Power Platfo… » | `src/content/services/fr/productivite/o-studio.json` |
...
|  | `/en/services/managed-it-services/maximize-the-use-of-your-m365-ecosystem/` | `/en/expertise/managed-it-services/maximize-the-use-of-your-m365-ecosystem/` | 194 | 209 | 1,08 |  | `src/content/services/en/services-ti-geres/maximisez-lutilisation-de-votre-ecosysteme-m365.json` |
...
|  | `/en/services/artificial-intelligence/` | `/en/expertise/artificial-intelligence/` | 629 | 682 | 1,08 | ≈ « We put AI to Work for Businesses and Public Organizations » · « Do You Have Questions About an Artificial Intelligence Pr… » · « Expertise in Artificial Intelligence » (+5) | `src/content/services/en/intelligence-artificielle.json` |
|  | `/en/services/artificial-intelligence/ai-opportunity-analysis/` | `/en/expertise/artificial-intelligence/ai-opportunity-analysis/` | 335 | 365 | 1,09 | ≈ « Not sure how to start integrating AI into your business? » · « Let's Meet » | `src/content/services/en/intelligence-artificielle/analyse-opportunites-ia.json` |
|  | `/en/services/productivity-consulting/o-studio/` | `/en/expertise/productivity-consulting/o-studio/` | 574 | 626 | 1,09 |  | `src/content/services/en/productivite/o-studio.json` |
...
|  | `/en/services/productivity-consulting/` | `/en/expertise/productivity-consulting/` | 574 | 642 | 1,12 | ≈ « Our Productivity Expertise » · « Our Top Productivity Solutions » · « O bureau - Office Booking app » (+1) | `src/content/services/en/productivite.json` |
|  | `/en/services/cybersecurity/pentest/` | `/en/expertise/cybersecurity/pentest/` | 264 | 296 | 1,12 | ≈ « Request Your Penetration Testing Services » | `src/content/services/en/cybersecurite/test-intrusion-pentest.json` |
...
|  | `/en/services/productivity-consulting/employee-platform-intranet/` | `/en/expertise/productivity-consulting/employee-platform-intranet/` | 376 | 439 | 1,17 | ≈ « Human Resources Conversational Agent with AI » · « The Platform for a Unified, Modern Employee Experience » | `src/content/services/en/productivite/plateforme-employe-intranet.json` |
...
|  | `/en/services/productivity-consulting/copilot-studio/` | `/en/expertise/productivity-consulting/copilot-studio/` | 166 | 213 | 1,28 |  | `src/content/services/en/productivite/copilot-studio.json` |
...
|  | `/en/services/cybersecurity/` | `/en/expertise/cybersecurity/` | 427 | 568 | 1,33 | ≈ « Sector-Specific Expertise for Your Cybersecurity Services » | `src/content/services/en/cybersecurite.json` |
|  | `/fr/services/cybersecurite/` | `/expertise/cybersecurite/` | 484 | 690 | 1,43 |  | `src/content/services/fr/cybersecurite.json` |
|  | `/en/services/strategic-advice/law-25-compliance/` | `/en/expertise/strategic-advice/law-25-compliance/` | 108 | 166 | 1,54 | ≈ « Assess your organization's compliance by answering these … » · « Contact us for a personalized assessment! » | `src/content/services/en/conseil-strategique/conformite-loi-25.json` |
|  | `/fr/services/cybersecurite/cybersecurite-sante/` | `/expertise/cybersecurite/cybersecurite-sante/` | 319 | 585 | 1,83 | ≈ « Les enjeux de cybersécurité dans le secteur de la santé » · « Bénéficiez d’un accompagnement personnalisé » · « Victrix assure une cybersécurité et confidentialité de pr… » | `src/content/services/fr/cybersecurite/cybersecurite-sante.json` |
|  | `/en/services/cybersecurity/cybersecurity-healthcare/` | `/en/expertise/cybersecurity/cybersecurity-healthcare/` | 246 | 488 | 1,98 | ≈ « Cybersecurity Challenges in the Healthcare Sector » · « Take Advantage of Personalized Support » · « Victrix Provides First-Class Cybersecurity and Confidenti… » | `src/content/services/en/cybersecurite/cybersecurite-sante.json` |
...
|  | `/en/ressources/copilot-studio-agents/` | `/en/copilot-studio-agents/` | 1177 | 1186 | 1,01 | ≈ « Le saviez-vous? » | `src/content/blog/en/agents-copilot-studio.md` |
...
|  | `/fr/ressources/agents-copilot-studio/` | `/agents-copilot-studio/` | 1311 | 1335 | 1,02 | ≈ « Donnez les outils à vos équipes pour performer. Créez vot… » | `src/content/blog/fr/agents-copilot-studio.md` |
